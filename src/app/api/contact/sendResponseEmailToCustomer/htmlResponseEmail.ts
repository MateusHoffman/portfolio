...
const CONTACT_MESSAGE_FIELDS: Record<keyof IResponseEmail, string> = {
  email: "Email:",
  smartphone: "Celular:",
};

export const generateHtmlResponseEmail = () => {
  const entries = Object.entries({email: process.env.NEXT_PUBLIC_MY_EMAIL, smartphone: "+55 19 989428951"}) as [keyof IResponseEmail, string][];
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td style="padding: 0 0 0 0; font-size: 16px; line-height: 25px; color: #232323;" class="padding message-content">
                            <h2>Agradeço pelo contato. Farei questão de responder em breve.</h2>
