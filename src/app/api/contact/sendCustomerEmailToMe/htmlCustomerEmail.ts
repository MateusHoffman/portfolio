...
const CONTACT_MESSAGE_FIELDS: Record<keyof ICustomerEmail, string> = {
  email: "Email",
  subject: "Assunto",
  message: "Mensagem",
};

export const generateHtmlCustomerEmail = (data: ICustomerEmail) => {
  const entries = Object.entries(data) as [keyof ICustomerEmail, string][];
